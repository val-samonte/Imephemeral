...
export const FundModal = () => {
  ...
  const [sessionLamports, setSessionLamports] = useState(undefined)
  ...
  if (typeof sessionLamports === 'undefined') return null
  ...
  return (
    <div className='bg-black/20 fixed h-screen inset-x-0 top-0 flex items-center justify-center'>
